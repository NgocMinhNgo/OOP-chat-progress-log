module TryListViewChatCopy {
    ...
    requires okhttp3;
    opens TryListViewChatCopy to javafx.fxml;

    opens TryListViewChatCopy.application to
...
//    opens pickpal.controller to com.google.gson, org.seleniumhq.selenium.api;
    ...
    exports TryListViewChatCopy;
    exports TryListViewChatCopy.application;
    exports TryListViewChatCopy.entity;
    opens TryListViewChatCopy.entity to javafx.fxml;
}